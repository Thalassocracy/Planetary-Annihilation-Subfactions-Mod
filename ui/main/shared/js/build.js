var Build = (function() {
    ...
    HotkeyModel.SpecIdToGridMap = {
		...
		"/pa/units/foundation/factory/bot_factory_adv_f.json": ["factoryf", 9],
		"/pa/units/foundation/factory/vehicle_factory_f.json": ["factoryf", 16],
		
		"/pa/units/foundation/turret/laser_defense_adv_f.json": ["combatf", 0],
        "/pa/units/foundation/turret/artillery_long_f.json": ["combatf", 2],
        "/pa/units/foundation/turret/tactical_missile_launcher_f.json": ["combatf", 3],
        "/pa/units/foundation/turret/nuke_launcher_f.json": ["combatf", 4],
        "/pa/units/foundation/turret/laser_defense_f.json": ["combatf", 6],
        "/pa/units/foundation/turret/air_defense_adv_f.json": ["combatf", 7],
        "/pa/units/foundation/turret/torpedo_launcher_adv_f.json": ["combatf", 9],
        "/pa/units/foundation/turret/anti_nuke_launcher_f.json": ["combatf", 10],
        "/pa/units/foundation/turret/laser_defense_single_f.json": ["combatf", 12],
        "/pa/units/foundation/turret/air_defense_f.json": ["combatf", 13],
        "/pa/units/foundation/turret/artillery_short_f.json": ["combatf", 14],
		...
		"/pa/units/foundation/bot/t2/fabrication_bot_adv_f.json": ["botf", 6],
        "/pa/units/foundation/bot/t2/assault_bot_adv_f.json": ["botf", 7],
        "/pa/units/foundation/bot/t2/bot_sniper_f.json": ["botf", 8],
        "/pa/units/foundation/bot/t2/fabrication_bot_combat_adv_f.json": ["botf", 9],
        "/pa/units/foundation/bot/t2/bot_tactical_missile_f.json": ["botf", 10],
        ...
        "/pa/units/foundation/air/t2/support_platform_f.json": ["airf", 0],

        "/pa/units/foundation/air/t2/fabrication_aircraft_adv_f.json": ["airf", 6],
        "/pa/units/foundation/air/t2/fighter_adv_f.json": ["airf", 7],
        "/pa/units/foundation/air/t2/gunship_f.json": ["airf", 8],
        "/pa/units/foundation/air/t2/bomber_adv_f.json": ["airf", 9],
        "/pa/units/foundation/air/t2/bomber_heavy_f.json": ["airf", 10],

        "/pa/units/foundation/air/fabrication_aircraft_f.json": ["airf", 12],
        "/pa/units/foundation/air/fighter_f.json": ["airf", 13],
        "/pa/units/foundation/air/bomber_f.json": ["airf", 14],
        "/pa/units/foundation/air/air_scout_f.json": ["airf", 15],
        "/pa/units/foundation/air/transport_f.json": ["airf", 16],

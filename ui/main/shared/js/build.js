var Build = (function() {
    ...
    HotkeyModel.SpecIdToGridMap = {
		...
		"/pa/units/foundation/titan/titan_air_f.json": ["factory_f", 1],
		"/pa/units/foundation/titan/titan_bot_f.json": ["factory_f", 3],
		"/pa/units/foundation/factory/unit_cannon_f.json": ["factory_f", 6],
		"/pa/units/foundation/factory/naval_factory_adv_f.json": ["factory_f", 7],
        "/pa/units/foundation/factory/air_factory_adv_f.json": ["factory_f", 8],
        "/pa/units/foundation/factory/bot_factory_adv_f.json": ["factory_f", 9],
        "/pa/units/foundation/factory/vehicle_factory_adv_f.json": ["factory_f", 10],
		"/pa/units/foundation/factory/orbital_launcher_f.json": ["factory_f", 12],
		"/pa/units/foundation/factory/naval_factory_f.json": ["factory_f", 13],
		"/pa/units/foundation/factory/air_factory_f.json": ["factory_f", 14],
		"/pa/units/foundation/factory/bot_factory_f.json": ["factory_f", 15],
		"/pa/units/foundation/factory/bot_factory_adv_f.json": ["factory_f", 9],
		"/pa/units/foundation/factory/vehicle_factory_f.json": ["factory_f", 16],
		
		"/pa/units/foundation/turret/laser_defense_adv_f.json": ["combat_f", 0],
        "/pa/units/foundation/turret/artillery_long_f.json": ["combat_f", 2],
        "/pa/units/foundation/turret/tactical_missile_launcher_f.json": ["combat_f", 3],
        "/pa/units/foundation/turret/nuke_launcher_f.json": ["combat_f", 4],
        "/pa/units/foundation/turret/laser_defense_f.json": ["combat_f", 6],
        "/pa/units/foundation/turret/air_defense_adv_f.json": ["combat_f", 7],
        "/pa/units/foundation/turret/torpedo_launcher_adv_f.json": ["combat_f", 9],
        "/pa/units/foundation/turret/anti_nuke_launcher_f.json": ["combat_f", 10],
        "/pa/units/foundation/turret/laser_defense_single_f.json": ["combat_f", 12],
        "/pa/units/foundation/turret/air_defense_f.json": ["combat_f", 13],
        "/pa/units/foundation/turret/artillery_short_f.json": ["combat_f", 14],
        "/pa/units/foundation/turret/torpedo_launcher_f.json": ["combat_f", 15],
        "/pa/units/foundation/turret/ion_defense_f.json": ["combat_f", 16],
		
		
		
		"/pa/units/foundation/titan/titan_structure_f.json": ["utility_f", 0],
        "/pa/units/foundation/utility/control_module.json": ["utility_f", 1],
		"/pa/units/foundation/utility/font_of_creation.json": ["utility_f", 6],
        "/pa/units/foundation/utility/radar_adv.json": ["utility_f", 8],
        "/pa/units/foundation/utility/energy_plant_2_f.json": ["utility_f", 3],
        "/pa/units/foundation/utility/metal_extractor_adv.json": ["utility_f", 4],
        "/pa/units/foundation/utility/delta_v_engine.json": ["utility_f", 7],
        "/pa/units/foundation/utility/radar.json": ["utility_f", 14],
        "/pa/units/foundation/utility/energy_plant.json": ["utility_f", 9],
        "/pa/units/foundation/utility/metal_extractor.json": ["utility_f", 10],
        "/pa/units/foundation/utility/land_barrier.json": ["utility_f", 12],
        "/pa/units/foundation/utility/teleporter.json": ["utility_f", 13],
        "/pa/units/foundation/utility/energy_storage.json": ["utility_f", 15],
        "/pa/units/foundation/utility/metal_storage.json": ["utility_f", 16],
		
		
		"/pa/units/foundation/vehicle/t2/fabrication_vehicle_adv_f.json": ["vehicle_f", 6],
        "/pa/units/foundation/vehicle/t2/tank_laser_adv_f.json": ["vehicle_f", 7],
        "/pa/units/foundation/vehicle/t2/tank_heavy_armor_f.json": ["vehicle_f", 8],
        "/pa/units/foundation/vehicle/t2/tank_heavy_mortar_f.json": ["vehicle_f", 9],
        "/pa/units/foundation/vehicle/t2/tank_flak_f.json": ["vehicle_f", 10],

        "/pa/units/foundation/vehicle/fabrication_vehicle_f.json": ["vehicle_f", 12],
        "/pa/units/foundation/vehicle/tank_light_laser_f.json": ["vehicle_f", 13],
        "/pa/units/foundation/vehicle/tank_armor_f.json": ["vehicle_f", 14],
        "/pa/units/foundation/vehicle/land_scout_f.json": ["vehicle_f", 15],
        "/pa/units/foundation/vehicle/aa_missile_vehicle_f.json": ["vehicle_f", 16],
		
		
		"/pa/units/foundation/bot/t2/fabrication_bot_adv_f.json": ["bot_f", 6],
        "/pa/units/foundation/bot/t2/assault_bot_adv_f.json": ["bot_f", 7],
        "/pa/units/foundation/bot/t2/bot_sniper_f.json": ["bot_f", 8],
        "/pa/units/foundation/bot/t2/fabrication_bot_combat_adv_f.json": ["bot_f", 9],
        "/pa/units/foundation/bot/t2/bot_tactical_missile_f.json": ["bot_f", 10],
		
        "/pa/units/foundation/bot/fabrication_bot_f.json": ["bot_f", 12],
        "/pa/units/foundation/bot/assault_bot_f.json": ["bot_f", 13],
        "/pa/units/foundation/bot/bot_grenadier_f.json": ["bot_f", 14],
        "/pa/units/foundation/bot/fabrication_bot_combat_f.json": ["bot_f", 15],
        "/pa/units/foundation/bot/bot_bomb_f.json": ["bot_f", 16],
        "/pa/units/foundation/bot/bot_tesla_f.json": ["bot_f", 17],
		
		
        "/pa/units/foundation/air/t2/support_platform_f.json": ["air_f", 0],

        "/pa/units/foundation/air/t2/fabrication_aircraft_adv_f.json": ["air_f", 6],
        "/pa/units/foundation/air/t2/fighter_adv_f.json": ["air_f", 7],
        "/pa/units/foundation/air/t2/gunship_f.json": ["air_f", 8],
        "/pa/units/foundation/air/t2/bomber_adv_f.json": ["air_f", 9],
        "/pa/units/foundation/air/t2/bomber_heavy_f.json": ["air_f", 10],

        "/pa/units/foundation/air/fabrication_aircraft_f.json": ["air_f", 12],
        "/pa/units/foundation/air/fighter_f.json": ["air_f", 13],
        "/pa/units/foundation/air/bomber_f.json": ["air_f", 14],
        "/pa/units/foundation/air/air_scout_f.json": ["air_f", 15],
        "/pa/units/foundation/air/transport_f.json": ["air_f", 16],
		

        
		
		
		"/pa/units/foundation/naval/t2/carrier_f.json": ["sea_f",0],

        "/pa/units/foundation/naval/t2/fabrication_ship_adv_f.json": ["sea_f",6],
        "/pa/units/foundation/naval/t2/battleship_f.json": ["sea_f", 7],
        "/pa/units/foundation/naval/t2/borealis_f.json": ["sea_f", 8],
        "/pa/units/foundation/naval/t2/nuclear_sub_f.json": ["sea_f", 9],
        "/pa/units/foundation/naval/t2/hover_ship_f.json": ["sea_f",10],

        "/pa/units/foundation/naval/fabrication_ship_f.json": ["sea_f", 12],
        "/pa/units/foundation/naval/frigate_f.json": ["sea_f", 13],
        "/pa/units/foundation/naval/destroyer_f.json": ["sea_f", 14],
        "/pa/units/foundation/naval/sub_hunter_f.json": ["sea_f", 15],
        "/pa/units/foundation/naval/sea_scout_f.json": ["sea_f", 16],
        "/pa/units/foundation/naval/fabrication_barge_f.json": ["sea_f",17],

		"/pa/units/foundation/titan/titan_orbital.json": ["orbital_structure_f", 6],
        "/pa/units/foundation/orbital_structure/defense_satellite.json": ["orbital_structure_f", 12],
        "/pa/units/foundation/orbital_structure/mining_platform.json": ["orbital_structure_f", 13],
        "/pa/units/foundation/orbital_structure/orbital_factory.json": ["orbital_structure_f", 14],


        "/pa/units/foundation/orbital/orbital_battleship.json": ["orbital_f", 0],

        "/pa/units/foundation/orbital/heal_drone.json": ["orbital_f", 6],
        "/pa/units/foundation/orbital/orbital_laser.json": ["orbital_f", 7],
        "/pa/units/foundation/orbital/radar_satellite_adv.json": ["orbital_f", 8],
        "/pa/units/foundation/orbital/orbital_railgun.json": ["orbital_f", 9],


        "/pa/units/foundation/orbital/orbital_fabrication_bot.json": ["orbital_f", 12],
        "/pa/units/foundation/orbital/orbital_fighter.json": ["orbital_f", 13],
        "/pa/units/foundation/orbital/radar_satellite.json": ["orbital_f", 14],
        "/pa/units/foundation/orbital/orbital_lander.json": ["orbital_f", 15],
        "/pa/units/foundation/orbital/orbital_probe.json": ["orbital_f", 16]
